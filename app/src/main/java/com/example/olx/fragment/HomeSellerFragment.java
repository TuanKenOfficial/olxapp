...
public class HomeSellerFragment extends Fragment {
    ...
    private AdapterAddProductSeller adapterProductSeller;
        ...
        binding.searchProductEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try {
                    ...
                    adapterProductSeller.getFilter().filter(query);
                }catch (Exception e){
    ...
    private void loadFilteredProducts(String selected) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            if (selected.equals(modelAddProduct.getCategory())){
                                if(distance<=MAX_DISTANCE_TO_LOAD_ADS_KM){
                                    Log.d(TAG, "onDataChange: category equals All");
                        ...
                        //setup adapter
                        adapterProductSeller = new AdapterAddProductSeller(mContext, productList);
                        //set adapter
